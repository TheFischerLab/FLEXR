...
def get_coot_loc():
    libraryloc = "/Applications/ccp4-9/coot_py3/Frameworks/Python.framework/Versions/3.9/lib/python3.9/site-packages/coot/library/rotamer_library_coot.csv"
    cootloc = "/Applications/ccp4-9/coot_py3/Frameworks/Python.framework/Versions/3.9/lib/python3.9/site-packages/coot"
    cootexe = "/Applications/ccp4-9/coot_py3/bin/coot"
    return libraryloc,cootloc,cootexe
